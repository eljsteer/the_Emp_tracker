...
//------------------------------------------------->>
// Main Query Functions to Query MySQL
//=================================================>>
...
//   // Query Function to SQL to retrieve Total Budget of Department
//   getBudget() {
//     return dbConnect.promise()
//     .query(
//     `SELECT role, SUM(salary) AS Total FROM employee WHERE manager_id IS NULL`
//     );
// };

//------------------------------------------------->>
// Helper Functions to retieve data for listsOptions
//=================================================>>
